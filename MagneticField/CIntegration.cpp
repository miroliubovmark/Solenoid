...
BOOL CIntegration::RingOfCurrent_FieldDerivative(const CPoint3D& crRingCentrePoint, const F64 f64Rs, const F64 f64Current, const CPoint3D& crInvestigationPoint, CVector3D *pResult)
{
    F64 f64_dB_dR_Result, f64_dB_dZ_Result, f64X_Result, f64Y_Result, f64_dIntegral1, f64_dIntegral2, f64CosTheta, f64SinTheta;
    ...
    f64X_Result = f64_dB_dR_Result * f64CosTheta;
    f64Y_Result = f64_dB_dZ_Result * f64SinTheta;

    pResult->SetCoordinates(f64X_Result, f64Y_Result, f64_dB_dZ_Result);
